...
// Ported from "React Bits — Fold Text" (reactbits.dev), the component this
// project's typography-fold identity is built on. Each character/word/line
// is an independently hinged panel (perspective + rotateX/rotateY on its
// own transform-origin) that folds open rather than fading or sliding in —
// GSAP + ScrollTrigger drive it, not Framer Motion, since this needs a real
// scroll-scrubbed trigger (trigger="scroll"), not just a mount animation.
